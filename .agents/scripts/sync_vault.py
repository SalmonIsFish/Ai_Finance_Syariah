...
def main():
    ...
    # A Stop hook signals "let the turn end" by producing no stdout and
    # exiting 0. There is no "stop" decision value -- the schema accepts only
    # "approve"/"block", and "block" would force the turn to CONTINUE, which is
    # the opposite of what this hook wants. Printing anything here made Claude
    # Code report a validation error on every single turn.
